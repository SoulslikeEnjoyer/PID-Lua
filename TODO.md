...
- [x] Add vector PID-Controller implementation:
  - [x] PID module
  - [x] Path module
  - [x] Spiral movement script
- [x] If it is possible to draw multiple plots in one script call, then change SpiralMovement also
